// zip.js — a tiny, dependency-free ZIP reader/writer for the side panel.
//
...
//
// API (attached to window for the classic-script side panel):
...
(function () {
  ...
  window.CEZip = { zipSync, unzipSync, crc32 };
})();
